...
1. **Command:**
   ...
   1. !python train_privacy_joint.py --control_name ML100K_user_explicit_ae_0_iid_1 --train_mode not_private --federated_mode decoder --num_workers 0 --init_seed 0 --num_experiments 1 --log_interval 0.25 --device cuda --resume_mode 0 --verbose False
   1. !python test_privacy_joint.py --control_name ML100K_user_explicit_ae_0_iid_1 --train_mode not_private --federated_mode decoder --num_workers 0 --init_seed 0 --num_experiments 1 --log_interval 0.25 --device cuda --resume_mode 0 --verbose False
