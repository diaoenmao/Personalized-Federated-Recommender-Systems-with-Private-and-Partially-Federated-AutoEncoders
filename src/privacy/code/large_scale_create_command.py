...
def main():
    ...
    run_file = open('./{}.sh'.format(f'large_scale_train_server_4'), 'w')
    run_file.write('#!/bin/bash\n')
    run_file.close()

    run_file = open('./{}.sh'.format(f'large_scale_test_server_4'), 'w')
    run_file.write('#!/bin/bash\n')
    run_file.close()
    ...
    run_file = open('./{}.sh'.format(f'pre_run_large_scale_train_server_4'), 'w')
    run_file.write('#!/bin/bash\n')
    run_file.close()

    run_file = open('./{}.sh'.format(f'pre_run_large_scale_test_server_4'), 'w')
    run_file.write('#!/bin/bash\n')
    run_file.close()
    return
