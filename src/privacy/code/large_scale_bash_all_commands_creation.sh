...
# run joint
python3 large_scale_create_command.py --run train --device cuda --num_gpus 4 --round 32 --world_size 1 --num_experiments 1 --experiment_step 1 --init_seed 0 --resume_mode 0 --log_interval 0.25 --file privacy_joint --data ML1M_Douban
python3 large_scale_create_command.py --run test --device cuda --num_gpus 4 --round 32 --world_size 1 --num_experiments 1 --experiment_step 1 --init_seed 0 --resume_mode 0 --log_interval 0.25 --file privacy_joint --data ML1M_Douban

# # federate => average all
python3 large_scale_create_command.py --run train --device cuda --num_gpus 4 --round 32 --world_size 1 --num_experiments 1 --experiment_step 1 --init_seed 0 --resume_mode 0 --log_interval 0.25 --file privacy_federated_all --data ML1M_Douban
python3 large_scale_create_command.py --run test --device cuda --num_gpus 4 --round 32 --world_size 1 --num_experiments 1 --experiment_step 1 --init_seed 0 --resume_mode 0 --log_interval 0.25 --file privacy_federated_all --data ML1M_Douban

# # federate => average decoder
python3 large_scale_create_command.py --run train --device cuda --num_gpus 4 --round 32 --world_size 1 --num_experiments 1 --experiment_step 1 --init_seed 0 --resume_mode 0 --log_interval 0.25 --file privacy_federated_decoder --data ML1M_Douban
python3 large_scale_create_command.py --run test --device cuda --num_gpus 4 --round 32 --world_size 1 --num_experiments 1 --experiment_step 1 --init_seed 0 --resume_mode 0 --log_interval 0.25 --file privacy_federated_decoder --data ML1M_Douban
