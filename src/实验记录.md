...
2. 测试average all (1M, 不加global_optimizer):
   ...
   6. 测试1个user1个node, implicit
      1. (断了)**node=max, fraction改为0.1, global_epoch=800, local epoch改为5，加layernorm, global_scheduler_lr=True, MAP=0.8546, epoch=602**
...
4. 测试fine tune:
   ...
   1. 测试100个node:
      ...
      1. 测试epoch个数的影响, explicit:
         ...
         1. *node=100, epoch=5, batch_size=10, lr=0.1, optimizer=SGD, rmse=0.9051, epoch=401*
         2. *node=100, epoch=10, batch_size=10, lr=0.1, optimizer=SGD, rmse=0.9051, epoch=401*
      2. 测试lr的影响, explicit:
      
      1. *node=100, epoch=5/10, batch_size=10, lr=0.1, optimizer=SGD, rmse=0.9051, epoch=401*
      
      2. *node=100, epoch=5/10, batch_size=10, lr=0.01, optimizer=SGD, rmse=0.9051, epoch=401*
      3. 测试batch_size的影响, explicit:
      1. *node=100, epoch=5/10, batch_size=5, lr=0.1/0.01, optimizer=SGD, rmse=0.9051, epoch=401*
         2. *node=100, epoch=5/10, batch_size=10, lr=0.1/0.01, optimizer=SGD, rmse=0.9051, epoch=401*
   4. 测试epoch个数的影响, implicit:
         1. *node=100, epoch=5, batch_size=10, lr=0.1, optimizer=SGD, MAP=0.9051, epoch=401*
      2. *node=100, epoch=10, batch_size=10, lr=0.1, optimizer=SGD, MAP=0.9051, epoch=401*
      2. 测试lr的影响, implicit:

         1. *node=100, epoch=5/10, batch_size=10, lr=0.1, optimizer=SGD, MAP=0.9051, epoch=401*
      
         2. *node=100, epoch=5/10, batch_size=10, lr=0.01, optimizer=SGD, MAP=0.9051, epoch=401*
      3. 测试batch_size的影响, implicit:
         1. *node=100, epoch=5/10, batch_size=5, lr=0.1/0.01, optimizer=SGD, MAP=0.9051, epoch=401*
         2. *node=100, epoch=5/10, batch_size=10, lr=0.1/0.01, optimizer=SGD, MAP=0.9051, epoch=401*
...
1. 验证代码修改正确: **node=100, fraction=0.1, global_epoch=800, local epoch=5,  加layernorm, local_optimizer=True, local_scheduler=True,  rmse=0.9038, epoch=776**
