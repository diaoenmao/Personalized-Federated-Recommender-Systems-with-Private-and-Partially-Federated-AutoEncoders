...
6. 修改:
   ...
   9. 实验补充2/20/2022
      ...
      3. partial average with local optimizer
         1. baseline:
            ...
            3. Not shuffle
               1. **node=300, epoch=800, local_epoch=5, optimizer=SGD, scheduler=cosine, shuffle=False, average_ratio=0.1, rmse=0.9405, test_epoch=200** （0.9423 -> 0.9408 ->0.9405）
               2. **node=300, epoch=800, local_epoch=5, optimizer=SGD, scheduler=cosine, shuffle=False, average_ratio=0.2, rmse=0.9366, test_epoch=200** (0.9378 -> 0.9356 -> 0.9366)
               3. **node=300, epoch=800, local_epoch=5, optimizer=SGD, scheduler=cosine, shuffle=False, average_ratio=0.3, rmse=0.9327, test_epoch=200** (0.9339 -> 0.9318 -> 0.9327)
            4. Shuffle:
               1. **node=300, epoch=800, local_epoch=5, optimizer=SGD, scheduler=cosine, shuffle=True, average_ratio=0.1, rmse=0.9375, test_epoch=200** (0.9389->0.9382->0.9375)
               2. **node=300, epoch=800, local_epoch=5, optimizer=SGD, scheduler=cosine, shuffle=True, average_ratio=0.2, rmse=0.9336, test_epoch=200** (0.9354 -> 0.9346 -> 0.9336)
               3. **node=300, epoch=800, local_epoch=5, optimizer=SGD, scheduler=cosine, shuffle=True, average_ratio=0.3, rmse=0.9298, test_epoch=200** (0.9309 -> 0.9303 -> 0.9298)
   ...
   10. 2/21/2022
       1. Fine tune, 使用Adam
       2. fix bug, first 100node, then 1user/node,  no local optimizer/local optimizer, 分item attribute
       3. find dataset
       4. New autoencoder
       5. x(embedding) 1 
          1. x 2 
